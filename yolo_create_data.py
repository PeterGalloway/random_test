...
files = glob.glob("DIRECTORY_TO_IMAGES/*.jpg")

model = YOLO('DIRECTORY_TO_YOLO_MODEL/yolov8x_person_face.pt')

# Define custom classes
# Execute prediction for specified categories on an image
total_time = []
for file in tqdm(files[:100], total=len(files[:100])):
	start = time.time()
